...
export const FooterYara = () => (
	<footer className="footer mt-auto py-3 text-center " // fixed-bottom // 
  > 
		<p>
          Made with 🍑 by
          <a 
          href="https://github.com/Yaralisa" //añadir tu github
          > 
            <img
              className="logo"
              src="https://avatars.githubusercontent.com/u/170345539?v=4"  // añadir una imagen, truco usar la de tu avatar de github
              style={{
              ...
              alt="logo"
            />
            Yaralisa {/* aqui se vera el texto en enlace, añadir tu propio Nick  */}
          </a>{" "}
          on
